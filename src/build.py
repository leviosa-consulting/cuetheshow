...
Outputs:
  ...
  ../site/index.html              hosted full build
  ../site/lite.html               hosted lite build
  ../site/cuetheshow-offline.html downloadable offline copy (= full build)
"""
import os
...
targets = [
    ...
    (os.path.join('site', 'index.html'), full),
    (os.path.join('site', 'lite.html'), lite),
    (os.path.join('site', 'cuetheshow-offline.html'), full),
]
